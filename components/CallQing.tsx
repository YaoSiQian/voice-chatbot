...
export default function CallQing() {
  const {
    userCall,
    userSpeak,
    userStopSpeaking,
  ...
  return (
    <div className="flex lg:flex-row lg:items-center lg:justify-center xxs:h-full flex-col items-center justify-end overflow-auto">
      <div className="bg-[url(../public/assets/Qing.gif)] lg:h-[500px] lg:w-[500px] xxs:h-0 w-full bg-no-repeat bg-contain bg-center"></div>
